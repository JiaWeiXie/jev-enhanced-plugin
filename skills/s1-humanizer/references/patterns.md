...
Pattern catalog adapted from Siqi Chen's `humanizer`; retain its upstream MIT notice.
Wikipedia-derived material and this catalog adaptation are distributed under
...
Authors: Wikipedia contributors, credited in the [page history](https://en.wikipedia.org/w/index.php?title=Wikipedia:Signs_of_AI_writing&action=history), including WikiProject AI Cleanup.
Upstream did not pin a source revision. No endorsement is implied.
Changes: extracted the upstream catalog into this reference; added navigation and
license attribution. The numbered pattern text is unchanged.

## Contents

- [A. Staging](#a-staging-instead-of-stating)
- [B. Rhythm](#b-rhythm-by-rule)
- [C. Inflation](#c-inflation-and-borrowed-authority)
- [D. Formatting](#d-formatting-by-rule)
- [E. Leftovers](#e-leftovers-from-the-chat-and-the-draft)
